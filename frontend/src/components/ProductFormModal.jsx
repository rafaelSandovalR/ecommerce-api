            ...
            <div className="bg-white p-6 rounded shadow-lg w-96">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input name="description" onChange={handleChange} className="w-full border p-2 rounded" />
                    </div>
                    ...
                    <div className="flex gap-2">
                        <div className="w-1/2">
                            ...
                            <input name="price" type="number" step="0.01" onChange={handleChange} className="w-full border p-2 rounded" required/>
                        </div>
                        <div className="w-1/2">
                            <label className="block text-sm font-medium text-gray-700">Stock</label>
                            <input name="stockQuantity" type="number" onChange={handleChange} className="w-full border p-2 rounded" required/>
                        </div>                        
                    </div>
                    ...
                    <div>
                        ...
                        <input name="imageUrl" placeholder="http://..." onChange={handleChange} className="w-full border p-2 rounded"/>
                    </div>
